...
public class AssetsService {
    ...
    //String currPage = "Asset ";

    @Value("${serviceUrl}")
    public  void setServiceUrl(String Url){
        serviceUrl=Url;
    }
    public List<APIAsset> getAssetAll(){
        APIResult api_Result;
        String path = "/assets/";
        APIAsset apiAssetToPutPost = null;
        api_Result = InvokeAPIService(serviceUrl, "null", path, "GET", "JSON", apiAssetToPutPost);

        return api_Result.getAPIAssets().getValue().getAPIAsset();
    }

    public List<APIAsset> getAssetByAssetID(String assetID){
        APIResult api_Result;
        String path = "/assets/"+assetID;
        APIAsset apiAssetToPutPost = null;
        api_Result = InvokeAPIService(serviceUrl, "null", path, "GET", "XML", apiAssetToPutPost);

        System.out.println(api_Result.getAPIAssets().getValue().getAPIAsset());
        return api_Result.getAPIAssets().getValue().getAPIAsset();
    }
    ...
    /**
     * Invokes the API Service, depending on parameter passed
     *
     * @param queryString - Query string to be passed in url
     * @param path - Resource Path
     * @param requestMethod - CRUD Method
     * @param xmlJson - Request/Response type - xml or json
     * @param apiAssetToPutPost - API Asset resource
     *
     */
    private static APIResult InvokeAPIService(String serviceUrl, String queryString, String path, String requestMethod, String xmlJson, APIAsset apiAssetToPutPost) {
        ...
        try {
            if (!"".equalsIgnoreCase(queryString)) {                                                                    //Proceed if querystring is not empty.
                ...
                System.out.println(apiReturnResult);
